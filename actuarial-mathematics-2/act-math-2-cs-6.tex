...
\[ \ax**{\endowxn} = \mathbb{E}[\sum_{k=1}^n \Ex[k]{x}] 
= \frac{1}{D_x}(N_{x} - N_{x+n}) = \frac{D_x + N_{x+1} - N_{x+n}}{D_x} = 1 + \ax**{x:\angl{n-1}} 
\]
...
with \( n = \omega + 1 - x \)
\[ \ax**[m|]{x} = \frac{N_{x+m}}{D_x} = \frac{N_x - N_x + N_{x+m}}{D_x} = \ax**{x} - \ax**{x:\angl m} \]
...
\[ \Ax{x} = \frac{M_x}{D_x} = \frac{vN_x - N_{x+1}}{D_x} = v \ax**{x} - \ax{x} \]
...
\begin{align*}
  \Ax{x:\angl n} = \Ex[n]{x} + \Ax[n]{x} &= \frac{1}{D_x}(D_{x+n} + M_x - M_{x+n}) \\
                                         &= \frac{v(N_x - N_{x+n}) - (N_{x+1} - N_{x+n})}{D_x}  \\
                                         &= \ax**{x:\angl n} - \ax{x:\angl{n-1}}  \\
                                         &= 1 - d \ax**{\endowxn}
\end{align*}
