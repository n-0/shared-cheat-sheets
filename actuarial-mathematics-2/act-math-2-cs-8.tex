...
\[( \qx[\frac{1}{2}]{x + \frac{1}{2}} = 1 - \frac{1 - q_x}{1 - \qx[\frac{1}{2}]{x}} = \frac{\frac{1}{2}\qx{x}}{1 - \frac{1}{2}\qx{x}} \]
...
\[ \px{x}[\gamma w] = \qx{x}[\gamma](g)h_x(g) \px[\frac{1}{2}]{y_x + \frac{1}{2}}[w](g') \]
where \( \gamma \) refers to the respective subpopulation and \( \gamma \) to the base cohort and \( g' = g + x - y_x \) 
(which is irrelevant under the stationarity assumption between cohorts or only one mortality table). \\
