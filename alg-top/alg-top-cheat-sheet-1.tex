...
The 1-dimensional faces are called edges, and the \((n-1)\)-dimensional faces are called facets.
...
and the singular homology group is given by \( H_n(X) \coloneqq Z_n(X)/B_n(X) \).
