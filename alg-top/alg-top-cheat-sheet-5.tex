...
The augmented version gives \(\tilde{H}_n(\{p\}) = 0\) for all \(n \in \mathbb{Z}\).
...
\(0 \longrightarrow G \xrightarrow{2} G \xrightarrow{0} G \dotsb \longrightarrow G \xrightarrow{2} G \xrightarrow{0} G \longrightarrow 0\)
if \( n \) is even, and
\(0 \longrightarrow G \xrightarrow{0} G \xrightarrow{2} G \dotsb \longrightarrow G \xrightarrow{2} G \xrightarrow{0} G \longrightarrow 0\)
...
where \( \varphi_\sharp \) is the induced map by the covering \( \varphi: S^n \to \mathbb{P}^n(\mathbb{R}) \) and 
\( \psi(\sigma) = \sigma_v + \sigma_{-v} = \sigma_v + A_{\sharp}(\sigma_v)\), where \( A: S^n \to S^n \) is the antipodal map
and \( \sigma_v : \Delta^k \to S^n \) the lift of some \( \sigma \in \Delta^k \to \mathbb{P}^n(\mathbb{R}) \), that is a map 
s.t. for \( v \in \varphi^{-1}(\sigma(e_0)) \) it holds \( \sigma_v(e_0) = v \).
...
\( \varphi_\ast : H_0(S^n; \mathbb{Z}/2\mathbb{Z}) \to H_{0}(\mathbb{P}^n(\mathbb{R}); \mathbb{Z}/2\mathbb{Z}) \) 
...
1. There is some \(p \in S^n\) s.t. \(f(p) = f(-p)\)
2. Additionally if \(f\) is odd, there is a \(q \in S^n\) with \(f(q) = 0\)
