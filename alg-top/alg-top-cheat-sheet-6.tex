...
If such a \(P\) exists, one says that \(f\) and \(g\) are cochain homotopic, and writes \(f \simeq g\).
...
\(
0 \longrightarrow \operatorname{Hom}(\mathbb{Z}, G) \xrightarrow{\text{id}} \operatorname{Hom}(\mathbb{Z}, G) \xrightarrow{0} \operatorname{Hom}(\mathbb{Z}, G) \xrightarrow{\text{id}} \operatorname{Hom}(\mathbb{Z}, G) \longrightarrow \dotsb 
\)
