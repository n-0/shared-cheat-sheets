...
Duration of Assets:
\( \frac{10}{300}\cdot 0 + 2\cdot\frac{120}{300} + \frac{170}{300}\cdot 8 = 5.33 \)
...
The overall duration is then given by 
\( D_{\text{equity}} =  \frac{300}{300 - 285}\cdot 5.33 - \frac{285}{300 - 285}\cdot 3.47 = 40.67 \text{years} \)
This can also be used to derive future value of the portfolio if interest changes, since it holds
